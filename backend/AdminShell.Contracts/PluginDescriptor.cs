...
public record PluginDescriptor
{
    ...
    public string? FrontendManifestResourceName { get; init; }
    public bool HasEmbeddedFrontend => !string.IsNullOrWhiteSpace(FrontendManifestResourceName);
    public string? FrontendBaseUrl => HasEmbeddedFrontend ? $"/api/plugins/{Id}/frontend" : null;
}
